...
PYBIND11_MODULE(EWF_pybind, m) {
    py::class_<WrightFisher>(m, "WrightFisher")
        .def(py::init<vector<double>, bool, double100, int, double, int,
            ...
            py::arg("selCoefs"))
        ///.def("Eigenvalues", &WrightFisher::eigenvalues, py::arg("k"))
        ///.def("Psi", &WrightFisher::Psi, py::arg("k"))
        .def("DiffusionRunner", &WrightFisher::DiffusionRunner, py::arg("nSim"),
            py::arg("x"), py::arg("startT"), py::arg("endT"), py::arg("par1"), py::arg("subName"),
        ...
        .def("BridgeDiffusionRunner", &WrightFisher::BridgeDiffusionRunner,
            ...
            py::arg("endT"), py::arg("sampleT"), py::arg("Absorption"), py::arg("par1"), py::arg("subName"),
        ...
        .def("DiffusionDensityCalculator",
            ...
            py::arg("Absorption"), py::arg("par1"), py::arg("subName"), py::arg("Filename"),
            py::arg("diffusion_threshold") = dt_default,
            py::arg("bridge_threshold") = bt_default)
        .def("BridgeDiffusionDensityCalculator",
            ...
            py::arg("sampleT"), py::arg("par1"), py::arg("subName"), py::arg("Absorption"), py::arg("Filename"),
            py::arg("diffusion_threshold") = dt_default,
            py::arg("bridge_threshold") = bt_default)
        .def("DualRunner", &WrightFisher::DualRunner, py::arg("nSim"), py::arg("startT"), py::arg("endT"),
            py::arg("par1"), py::arg("subName"), py::arg("Filename"),
            py::arg("diffusion_threshold") = dt_default,
            py::arg("bridge_threshold") = bt_default)
        .def("DiffusionTraj", &WrightFisher::DiffusionTraj, py::arg("times"),
                py::arg("par1"), py::arg("subName"), py::arg("Filename"),
                py::arg("diffusion_threshold") = dt_default,
                py::arg("bridge_threshold") = bt_default);
}
