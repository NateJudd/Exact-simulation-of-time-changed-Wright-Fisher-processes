...
ver = "T2"  # change to "N", "A", "P", or "G"

for ver in groups:
    # Extract parameter info for that version
    m1 = groups[ver]["m1"] # m1:1;m2:2 or m1:0.5;m2=0.5 
    m2 = groups[ver]["m2"]
    ...
    colors = ["#1f77b4","#ff7f0e","#2ca02c","#d62728"]#(cm.inferno(np.linspace(0.9,0.2,len(times)))) #["blue", "orange", "green", "red"]
    ...
    plt.xlabel("z")
    plt.ylabel("Density")
    plt.title("Density of the sWF transition function")
    ...
    output_dir = Path("C:\\Users\\User\\Documents\\TWF_26\\sWF") 
