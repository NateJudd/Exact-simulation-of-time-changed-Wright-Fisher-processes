...
/_____/  |__/|__/_/       
  ...
  void PhiSetter();
  double eigenvalues(int k);
  double Psi(double lambda, double par1, char subName);
  ...
  double100 UnconditionedDiffusionDensity(double100 x, double100 y, double100 t, double par1, char subName,
                                          const Options &o);
  double100 DiffusionDensityApproximationDenom(double100 x, double100 t, double par1, char subName,
                                               const Options &o);
  double100 DiffusionDensityApproximation(double100 x, double100 y, double100 t, double par1, char subName,
                                          const Options &o);
  double100 QmApprox(int m, double100 t, double par1, char subName, const Options &o);
  double100 UnconditionedBridgeDensity(double100 x, double100 z, double100 y,
                                       double100 s, double100 t, double par1, char subName,
                                       const Options &o);
  ...
  pair<int, int> DrawAncestralProcess(double100 t, double par1, char subName, const Options &o,
                                      boost::random::mt19937 &gen);
  pair<int, int> DrawAncestralProcessConditionalZero(
      double100 t, double par1, char subName, const Options &o, boost::random::mt19937 &gen);
  pair<pair<int, int>, int> DrawAncestralProcessConditionalInterior(
      double100 t, double100 x, double par1, char subName, const Options &o, boost::random::mt19937 &gen);
  int DrawAncestralProcessG1984(double100 t, boost::random::mt19937 &gen);
  int DrawSizebiasedAncestralProcess(int d, double100 t,
                                     boost::random::mt19937 &gen);
  pair<double100, int> DrawEndpoint(double100 x, double100 t1, double100 t2, double par1, char subName,
                                    const Options &o,
                                    boost::random::mt19937 &gen);
  pair<double100, int> DrawUnconditionedDiffusion(double100 x, double100 t, double par1, char subName,
                                                  const Options &o,
                                                  boost::random::mt19937 &gen);
  ...
  /// NATHAN's FUNCTIONS
  void DualRunner(int nSim, double100 startT, double100 endT, double par1, char subName, string& Filename,
      double100 diffusion_threshold, double100 bridge_threshold);
  void DiffusionTraj(vector<double100> times, double par1, char subName, string& Filename,
      double100 diffusion_threshold, double100 bridge_threshold);

  /// DIFFUSION SIMULATION - NON-NEUTRAL PATHS

  vector<vector<double100>> NonNeutralDraw(double100 x, double100 t1,
                                           double100 t2, double par1, char subName, bool Absorption,
                                           const Options &o,
                                           boost::random::mt19937 &gen);
  ...
  vector<int> DrawBridgePMFUnconditionalApprox(double100 x, double100 z,
                                               ...
                                               const Options &o,
                                               boost::random::mt19937 &gen);
  vector<int> DrawBridgePMFSameMutation(double100 x, double100 s, double100 t, double par1, char subName,
                                        const Options &o,
                                        boost::random::mt19937 &gen);
  ...
  vector<int> DrawBridgePMFSameMutationApprox(double100 x, double100 s,
                                              double100 t, double par1, char subName,
                                              boost::random::mt19937 &gen);
  vector<int> DrawBridgePMFDifferentMutation(double100 s, double100 t,
                                             double100 x, double par1, char subName, const Options &o,
                                             boost::random::mt19937 &gen);
  ...
  vector<int> DrawBridgePMFDifferentMutationApprox(double100 s, double100 t,
                                                   double100 x, double par1, char subName,
                                                   const Options &o,
                                                   boost::random::mt19937 &gen);
  ...
  vector<int> DrawBridgePMFInteriorMutationApprox(double100 x, double100 z,
                                                  ...
                                                  const Options &o,
                                                  boost::random::mt19937 &gen);
  vector<int> DrawBridgePMF(double100 x, double100 z, double100 s, double100 t, double par1, char subName,
  ...
  double100 mkModeFinder_Evaluator(int m, int k, double100 x, double100 z,
                                   double100 s, double100 t, double par1, char subName, const Options &o);
  double100 mkjModeFinder_Evaluator(int m, int k, int j, double100 x,
                                    double100 z, double100 s, double100 t, double par1, char subName,
                                    const Options &o);
  ...
  double100 mklModeFinder_Evaluator(int m, int k, int l, double100 x,
                                    double100 z, double100 s, double100 t, double par1, char subName,
                                    const Options &o);
  vector<int> mkModeFinder(double100 x, double100 z, double100 s, double100 t, double par1, char subName,
                           const Options &o);
  vector<int> mkjModeFinder(double100 x, double100 z, double100 s, double100 t, double par1, char subName,
                            const Options &o);
  vector<int> mkljModeFinder(double100 x, double100 z, double100 s, double100 t, double par1, char subName,
                             const Options &o);
  vector<int> mklModeFinder(double100 x, double100 z, double100 s, double100 t, double par1, char subName,
                            const Options &o);
  pair<double100, int> DrawBridgepoint(double100 x, double100 z, double100 t1,
                                       double100 t2, double100 s, double par1, char subName,
                                       const Options &o,
                                       boost::random::mt19937 &gen);
  pair<double100, int> DrawUnconditionedBridge(double100 x, double100 z,
                                               double100 t1, double100 t2,
                                               double100 s, double par1, char subName, const Options &o,
                                               boost::random::mt19937 &gen);

  /// BRIDGE SIMULATION - NON-NEUTRAL PATHS

  vector<vector<double100>> NonNeutralDrawBridge(double100 x, double100 t1,
                                                 double100 t2, double100 z, double par1, char subName,
                                                 bool Absorption,
                                                 const Options &o,
                                                 boost::random::mt19937 &gen);
  ...
  void DiffusionRunner(int nSim, double100 x, double100 startT, double100 endT, double par1, char subName,
 ...
 private:
  ...
  double100 Getd(vector<double100> &d, int i, double100 x, double100 z,
                 double100 t, double par1, char subName);
  double100 Getd2(vector<double100> &d, int i, double100 x, double100 t, double par1, char subName);
  ...
  double100 GetdBridgeInterior(vector<double100> &d, int i, double100 x,
                               double100 z, double100 t, double par1, char subName);
